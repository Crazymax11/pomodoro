...
export const Play = (props: IconProps) => {
	...
	return <svg version="1.1" width={props.size} height={props.size} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
		viewBox="0 0 300 300" >
		<g>
			<g>
				<circle fill="white" cx={150} cy={150} r={100} />
				<path fill={props.color} d="M150,0C67.157,0,0,67.162,0,150c0,82.841,67.157,150,150,150s150-67.159,150-150C300,67.162,232.843,0,150,0z
